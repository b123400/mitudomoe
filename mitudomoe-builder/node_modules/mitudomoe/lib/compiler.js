...
(function() {
  var Mitudomoe, MitudomoeCompiler, MitudomoeParser, Parser, Path, Q, preBuild,
  ...
  preBuild = require('./build').preBuild;
  ...
  MitudomoeCompiler = (function(_super) {
    ...
    MitudomoeCompiler.prototype.preBuild = function() {
      return preBuild(this);
    };
